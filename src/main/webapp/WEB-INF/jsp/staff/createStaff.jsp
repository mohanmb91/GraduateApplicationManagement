...
<div class="container">
	...
	<!-- Default panel contents -->
		<div class="panel-heading">Add Staff
			...
			<a href = "/springmvc/logout.html"> Log Out</a>
			</span>
		</div>
		...
		<div class="form-group">
		  <label for="deptId">select Which Department staff belongs to:</label>
		...
		<button class="btn-primary btn" type="reset">Clear</button>
