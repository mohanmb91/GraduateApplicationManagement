...
<div class="panel-heading">Welcome ${application.userName }!!<span style="float:right;"><a href = "/springmvc/logout.html"> Log Out</a>
</span></div>
...
<button class="btn-primary btn-block" type="submit">Home Page</button>
</form>
</div>
</div>
</div>
